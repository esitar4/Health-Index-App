    ...
    public class AdminAPIServiceTest
    {
        ...
        public async Task GetUsers_Success()
        {
            ...
            string testResponse = @"[{""id"":""138f7c43 - ff5c - 4726 - b345 - 821d96ce4333"",""username"":""c @c.c"",""parentId"":null,""dateOfBirth"":null,""weight"":null,""height"":null,""gender"":null,""admin"":false,""lockedStatus"":""Account Unlocked"",""lockEnd"":null},
                                     {""id"":""2bb65294 - e8d0 - 4d70 - 9f34 - 6fc393cb8832"",""username"":""b @b.b"",""parentId"":null,""dateOfBirth"":null,""weight"":null,""height"":null,""gender"":null,""admin"":false,""lockedStatus"":""Account Unlocked"",""lockEnd"":null},
                                     {""id"":""56efd970 - 1a6c - 4959 - a9d4 - 92fc4ddfb406"",""username"":""accTest @m.m"",""parentId"":""6d12746e-ecd9 - 4adf - aa35 - 7f011302607c"",""dateOfBirth"":null,""weight"":null,""height"":null,""gender"":null,""admin"":false,""lockedStatus"":""Account Unlocked"",""lockEnd"":""2023-04-03T13:07:12.7518815-06:00""},
                                     {""id"":""6d12746e-ecd9 - 4adf - aa35 - 7f011302607c"",""username"":""ed @mail.com"",""parentId"":""6275504f - aeb6 - 47fb - 9765 - 4cf623538a03"",""dateOfBirth"":""2001-06-29T00: 00:00"",""weight"":null,""height"":null,""gender"":""M"",""admin"":true,""lockedStatus"":""Account Unlocked"",""lockEnd"":null},
                                     {""id"":""9a30d8ad - 347e-4b71 - 9f86 - 7b4bd7cd132b"",""username"":""d @d.d"",""parentId"":null,""dateOfBirth"":null,""weight"":null,""height"":null,""gender"":null,""admin"":false,""lockedStatus"":""Account Unlocked"",""lockEnd"":null},
                                     {""id"":""a1e5ad96 - f5d9 - 4125 - a1e6 - f5b14ae1e700"",""username"":""e @e.e"",""parentId"":null,""dateOfBirth"":null,""weight"":null,""height"":null,""gender"":null,""admin"":false,""lockedStatus"":""Account Unlocked"",""lockEnd"":null},
                                     {""id"":""be475064 - 2db8 - 486d - aa88 - 0105a79db066"",""username"":""a @a.a"",""parentId"":""6275504f - aeb6 - 47fb - 9765 - 4cf623538a03"",""dateOfBirth"":null,""weight"":null,""height"":null,""gender"":null,""admin"":false,""lockedStatus"":""Account Unlocked"",""lockEnd"":null}]";

            var testJsonObject = JsonConvert.DeserializeObject<List<ApplicationUserDTO>>(testResponse);

            mockHttp.When("https://localhost:7005/api/admin/getUsers")
                .Respond("application/json", JsonConvert.SerializeObject(testJsonObject));

            var client = mockHttp.ToHttpClient();
            client.BaseAddress = new Uri("https://localhost:7005");
            var adminAPIService = new AdminAPIServices(client);

            List<ApplicationUserDTO> result = await adminAPIService.GetUsers();

            Console.WriteLine(result);
            Assert.That(result.Count, Is.EqualTo(7));
            Assert.That(result[0].Id.Equals("138f7c43 - ff5c - 4726 - b345 - 821d96ce4333"));
            Assert.That(JsonConvert.SerializeObject(result[2]).Equals(@"{""Id"":""56efd970 - 1a6c - 4959 - a9d4 - 92fc4ddfb406"",""Username"":""accTest @m.m"",""ParentId"":""6d12746e-ecd9 - 4adf - aa35 - 7f011302607c"",""DateOfBirth"":null,""Weight"":null,""Height"":null,""Gender"":null,""Admin"":false,""LockedStatus"":""Account Unlocked"",""LockEnd"":""2023-04-03T13:07:12.7518815-06:00""}"));
